...
const ROLE_ROUTES = {
  ...
  [UserRole.USER]: ['/analytics/user', '/dashboard/user'], // Backward compatibility
  [UserRole.STUDENT]: ['/analytics/user', '/dashboard/user', '/my-courses'], // Backward compatibility
  [UserRole.TEACHER]: ['/teacher', '/instructor'], // Backward compatibility
  [UserRole.INSTRUCTOR]: ['/teacher', '/instructor', '/analytics/instructor'],
  [UserRole.LEARNER]: ['/analytics/user', '/dashboard/user', '/my-courses'],
  [UserRole.MODERATOR]: ['/moderator', '/content-governance'],
  [UserRole.AFFILIATE]: ['/affiliate', '/analytics/affiliate']
};
...
function getRoleBasedRedirect(role: UserRole): string {
  switch (role) {
    ...
    case UserRole.MODERATOR:
      return '/content-governance/dashboard';
