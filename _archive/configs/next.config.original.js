...
const nextConfig = {
  ...
  // TypeScript and ESLint validation - ALWAYS enabled for quality assurance
  typescript: {
    // ✅ Always check TypeScript errors in all environments (dev, staging, production)
    ignoreBuildErrors: false,
  },
  eslint: {
    // ✅ Always run ESLint checks in all environments (dev, staging, production)
