  ...
  try {
    ...
    switch (action) {
      case 'latest': {
        ...
        const minRelevance = searchParams.get('minRelevance') || undefined;
    ...
    return NextRespoexport const POST = withAuth(async (request, context) => {
...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json(
      ...
      { stexport const PATCH = withAuth(async (request, context) => {
