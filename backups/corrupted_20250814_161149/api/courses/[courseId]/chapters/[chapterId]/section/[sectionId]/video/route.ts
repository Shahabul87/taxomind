...
import { withAuth, withAdminAuth, withOwnership, withPublicAexport const POST = withAuth(async (request, context, params) => {
  ...
  try {
    ...
    logger.error("[POST ERROR] Courses/Chapter/Secexport const PATCH = withAuth(async (request, context, params) => {"
...
export async function PATCH(
  ...
  try {
    ...
    logger.error("[PATCH ERROR] Videoexport const DELETE = withAuth(async (request, context, params) => {"
