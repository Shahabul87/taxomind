...
export class TestDataFactory {
   ...
   */
  static createUser(options: CreateUserOptions = {}): Omit<User, 'createdAt' | 'updatedAt'> {
    return {
   ...
   */
  static createUsers(count: number, options: CreateUserOptions = {}): Array<Omit<User, 'createdAt' | 'updatedAt'>> {
   ...
   */
  static createCourse(options: CreateCourseOptions = {}): Omit<Course, 'id' | 'createdAt' | 'updatedAt'> {
    const techTopics = [
   ...
   */
  static createCourses(count: number, options: CreateCourseOptions = {}): Array<Omit<Course, 'id' | 'createdAt' | 'updatedAt'>> {
   ...
   */
  static createChapter(options: CreateChapterOptions = {}): Omit<Chapter, 'id' | 'createdAt' | 'updatedAt'> {
    const chapterTopics = [
   ...
   */
  static createChapters(count: number, options: CreateChapterOptions = {}): Array<Omit<Chapter, 'id' | 'createdAt' | 'updatedAt'>> {
   ...
   */
  static createSection(options: CreateSectionOptions = {}): Omit<Section, 'id' | 'createdAt' | 'updatedAt'> {
    return {
   ...
   */
  static createSections(count: number, options: CreateSectionOptions = {}): Array<Omit<Section, 'id' | 'createdAt' | 'updatedAt'>> {
    return Array.from({ length: count }, (_, index) => 
  ...
  static createUserProgress(userId?: string, chapterId?: string) {
    return {
      ...
      progressPercentage: faker.number.float({ min: 0, max: 100, fractionDigits: 1 }),
    };
  }
