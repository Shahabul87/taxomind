...
// Force Node.js runtimexport const DELETE = withAuth(async (request, context, params) => {
  ...
  try {
    ...
    return NextResponse.json({ 
      ...
      details: error instanceof Error ? error.messexport const PATCH = withAuth(async (request, context, params) => {
...
export async function GET(
  ...
  try {
    ...
    console.errorexport const PUT = withAuth(async (request, context, params) => {
