import { examReducer, initialExamState, ExamAction } from '@/app/(protected)/teacher/courses/[courseId]/chapters/[chapterId]/section/[sectionId]/_components/exam-creator/exam-reducer';
