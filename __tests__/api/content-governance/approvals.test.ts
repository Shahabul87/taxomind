...
import { GET, POST } from '@/app/api/content-governance/approvals/route';
import { NextRequest } from 'next/server';

describe('/api/content-governance/approvals route', () => {
  it('GET returns 501 placeholder response', async () => {
    const req = new NextRequest('http://localhost:3000/api/content-governance/approvals');
