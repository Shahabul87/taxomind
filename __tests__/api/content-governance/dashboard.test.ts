...
import { GET } from '@/app/api/content-governance/dashboard/route';
import { NextRequest } from 'next/server';

describe('/api/content-governance/dashboard route', () => {
  it('returns 501 placeholder response', async () => {
    const req = new NextRequest('http://localhost:3000/api/content-governance/dashboard');
