/**
 * Science & Engineering Category Prompt Enhancer (ARROW-Based)
 *
 * Covers: Physics, Chemistry, Biology, Environmental Science, Mechanical Engineering,
 * Electrical Engineering, Civil Engineering, Robotics, DSP, Control Systems,
 * Thermodynamics, Fluid Dynamics, Materials Science, Biomedical, Aerospace, Chemical
 *
 * Research basis:
 * - ARROW Framework: Application-first, reverse-engineer, intuition before formalism
 * - MIT OCW structure (Walter Lewin, Neri Oxman): Demo-first physics & engineering
 * - CDIO (Conceive-Design-Implement-Operate) engineering education framework
 * - Feynman's teaching approach: "What I cannot create, I do not understand"
 * - Project-based learning in engineering (Olin College model)
 * - Failure analysis pedagogy (engineering case studies: Tacoma Narrows, Challenger)
 */

import type { CategoryPromptEnhancer } from './types';

export const engineeringEnhancer: CategoryPromptEnhancer = {
  ...
  domainExpertise: `You are also an expert engineer and scientist who has designed real systems — circuits, bridges, reactors, robots, signal processors — and teaches by showing the system FIRST, then reverse-engineering how it works.
...
- That every engineering discipline has its own "feel" — the tactile intuition of mechanics, the signal-flow thinking of EE, the systems thinking of chemical engineering`,
  ...
  teachingMethodology: `## ENGINEERING TEACHING METHODOLOGY (ARROW-Based)
...
- **Late chapters**: Open-ended design projects, failure analysis case studies, system integration. Students design from requirements.`,
  ...
  contentTypeGuidance: `## CONTENT TYPE SELECTION FOR ENGINEERING COURSES
...
- Include at least one failure analysis case study per major topic area`,
  ...
  qualityCriteria: `## ENGINEERING COURSE QUALITY CRITERIA
...
5. **Ends with a design question** — challenges students to apply the concept under constraints`,
  ...
  chapterSequencingAdvice: `## ENGINEERING COURSE CHAPTER SEQUENCING
