/**
 * Data Science, Machine Learning & AI Category Prompt Enhancer
 *
 * Covers: Data Science, Machine Learning, Artificial Intelligence,
 * Deep Learning, Data Engineering, Data Analytics, NLP, Computer Vision
 *
 * Research basis:
 * - Stanford CS229 (Andrew Ng): Math foundations → supervised → unsupervised → RL
 * - Deep Learning Specialization (Coursera): NN → Optimization → Structuring → CNN → RNN
 * - fast.ai (Jeremy Howard): Top-down, practical-first approach
 * - 3Blue1Brown: Intuition-first visualization of math concepts
 * - Kaggle competition-based learning pedagogy
 * - AIMA (Russell & Norvig): Search → Knowledge → Uncertainty → Learning
 */

import type { CategoryPromptEnhancer } from './types';

export const dataScienceMLEnhancer: CategoryPromptEnhancer = {
...
- Provide "math refresher" sidebars for linear algebra, calculus, probability — don't assume prerequisites`,
  ...
  contentTypeGuidance: `## CONTENT TYPE SELECTION FOR ML/AI COURSES
...
- Include visualization sections — plots, charts, confusion matrices, learning curves`,
  ...
  qualityCriteria: `## ML/AI COURSE QUALITY CRITERIA
...
5. **Shows evaluation properly** — uses appropriate metrics, train/test splits, cross-validation`,
  ...
  chapterSequencingAdvice: `## ML/AI COURSE CHAPTER SEQUENCING
