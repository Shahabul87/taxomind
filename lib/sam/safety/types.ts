 ...
 */
export type DiscouragingCategory =
  | 'absolute_negative'    // "You will never...", "You can't..."
  | 'personal_attack'      // "You're not smart enough"
  | 'dismissive'           // "This is wrong", "You clearly didn't..."
  | 'comparing_negatively' // "Unlike other students..."
  | 'hopelessness'         // "There's no point...", "It's too late..."
  | 'labeling'             // "You're a bad student"
  | 'sarcasm'              // Detected sarcastic or mocking tone
  | 'condescending';       // "Obviously...", "Even a child..."
...
export type FramingIssueType =
  | 'missing_positives'
  | 'criticism_without_guidance'
  | 'fixed_mindset_language'
  | 'no_next_steps'
  | 'vague_feedback'
  | 'unbalanced_criticism'
  | 'missing_encouragement';
 ...
 */
export const DEFAULT_FAIRNESS_CONFIG: Required<
  Omit<FairnessValidatorConfig, 'logger' | 'customDiscouragingPhrases' | 'customBiasPatterns'>
> = {
  minPassingScore: 70,
 ...
 */
export const SEVERITY_WEIGHTS: Record<SafetySeverity, number> = {
  low: 5,
  medium: 15,
  high: 30,
  critical: 50,
