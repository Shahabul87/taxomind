...
__export(index_exports, {
  CalibrationBucketSchema: () => CalibrationBucketSchema,
  CalibrationReportSchema: () => CalibrationReportSchema,
  CalibrationSampleSchema: () => CalibrationSampleSchema,
  GoldenTestCaseBuilder: () => GoldenTestCaseBuilder,
  GoldenTestCaseSchema: () => GoldenTestCaseSchema,
  GoldenTestRunner: () => GoldenTestRunner,
  InMemoryCalibrationStore: () => InMemoryCalibrationStore,
  InMemoryGoldenTestStore: () => InMemoryGoldenTestStore,
  InMemoryRegressionAlertStore: () => InMemoryRegressionAlertStore,
  InMemoryTestResultStore: () => InMemoryTestResultStore,
  InMemoryTestRunStore: () => InMemoryTestRunStore,
  RegressionAlertSchema: () => RegressionAlertSchema,
  TestCaseCategorySchema: () => TestCaseCategorySchema,
  TestCaseStatusSchema: () => TestCaseStatusSchema,
  TestResultSchema: () => TestResultSchema,
  TestRunSchema: () => TestRunSchema,
  arrayLengthValidator: () => arrayLengthValidator,
  confidenceValidator: () => confidenceValidator,
  containsKeysValidator: () => containsKeysValidator,
  createBuiltInValidators: () => createBuiltInValidators,
  createGoldenTestRunner: () => createGoldenTestRunner,
  createInMemoryCalibrationStore: () => createInMemoryCalibrationStore,
  createInMemoryGoldenTestStore: () => createInMemoryGoldenTestStore,
  createInMemoryRegressionAlertStore: () => createInMemoryRegressionAlertStore,
  createInMemoryTestResultStore: () => createInMemoryTestResultStore,
  createInMemoryTestRunStore: () => createInMemoryTestRunStore,
  createTestingSystem: () => createTestingSystem,
  createValidator: () => createValidator,
  equalsValidator: () => equalsValidator,
  inRangeValidator: () => inRangeValidator,
  matchesPatternValidator: () => matchesPatternValidator,
  ...
  testCase: () => testCase,
  typeOfValidator: () => typeOfValidator
});
module.exports = __toCommonJS(index_exports);

// src/types.ts
var import_zod = require("zod");
var TestCaseStatusSchema = import_zod.z.enum([
  "pending",
  "passed",
  "failed",
  "skipped",
...
var TestCaseCategorySchema = import_zod.z.enum([
  "content_generation",
  "assessment",
  "tutoring",
  "feedback",
...
var GoldenTestCaseSchema = import_zod.z.object({
  ...
  expectedOutput: import_zod.z.record(import_zod.z.unknown()).optional(),
  expectedBehavior: import_zod.z.string().optional(),
  validationRules: import_zod.z.array(import_zod.z.string()).default([]),
...
var TestResultSchema = import_zod.z.object({
  ...
  actualOutput: import_zod.z.record(import_zod.z.unknown()).optional(),
  duration: import_zod.z.number(),
  validationResults: import_zod.z.array(
    import_zod.z.object({
...
var TestRunSchema = import_zod.z.object({
  id: import_zod.z.string(),
  name: import_zod.z.string().optional(),
  startedAt: import_zod.z.date(),
  completedAt: import_zod.z.date().optional(),
  totalTests: import_zod.z.number(),
  passed: import_zod.z.number(),
  failed: import_zod.z.number(),
  skipped: import_zod.z.number(),
  errors: import_zod.z.number(),
  duration: import_zod.z.number().optional(),
  results: import_zod.z.array(TestResultSchema),
  metadata: import_zod.z.record(import_zod.z.unknown()).optional()
});
var CalibrationSampleSchema = import_zod.z.object({
  id: import_zod.z.string(),
  category: TestCaseCategorySchema,
  input: import_zod.z.record(import_zod.z.unknown()),
  output: import_zod.z.record(import_zod.z.unknown()),
  predictedConfidence: import_zod.z.number().min(0).max(1),
  actualAccuracy: import_zod.z.number().min(0).max(1).optional(),
  humanVerified: import_zod.z.boolean().default(false),
  humanScore: import_zod.z.number().min(0).max(1).optional(),
  verifiedBy: import_zod.z.string().optional(),
  verifiedAt: import_zod.z.date().optional(),
  createdAt: import_zod.z.date(),
  metadata: import_zod.z.record(import_zod.z.unknown()).optional()
});
var CalibrationBucketSchema = import_zod.z.object({
  confidenceRange: import_zod.z.object({
    min: import_zod.z.number(),
    max: import_zod.z.number()
  }),
  sampleCount: import_zod.z.number(),
  averageConfidence: import_zod.z.number(),
  averageAccuracy: import_zod.z.number(),
  calibrationError: import_zod.z.number()
  // |avgConfidence - avgAccuracy|
});
var CalibrationReportSchema = import_zod.z.object({
  id: import_zod.z.string(),
  category: TestCaseCategorySchema.optional(),
  generatedAt: import_zod.z.date(),
  sampleCount: import_zod.z.number(),
  buckets: import_zod.z.array(CalibrationBucketSchema),
  expectedCalibrationError: import_zod.z.number(),
  maxCalibrationError: import_zod.z.number(),
  overconfidenceRate: import_zod.z.number(),
  underconfidenceRate: import_zod.z.number(),
  recommendations: import_zod.z.array(import_zod.z.string())
});
var RegressionAlertSchema = import_zod.z.object({
  id: import_zod.z.string(),
  testCaseId: import_zod.z.string(),
  severity: import_zod.z.enum(["warning", "error", "critical"]),
  ...
  previousValue: import_zod.z.unknown(),
  currentValue: import_zod.z.unknown(),
  threshold: import_zod.z.number().optional(),
  detectedAt: import_zod.z.date(),
  acknowledged: import_zod.z.boolean().default(false),
  acknowledgedBy: import_zod.z.string().optional(),
  acknowledgedAt: import_zod.z.date().optional(),
  metadata: import_zod.z.record(import_zod.z.unknown()).optional()
});
