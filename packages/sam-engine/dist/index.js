...
__export(index_exports, {
  ...
  SAMChat: () => SAMChat,
  SAMEngine: () => SAMEngine,
  SAMFloatingAssistant: () => SAMFloatingAssistant,
  SAMProvider: () => SAMProvider,
  SAMReactContext: () => SAMReactContext,
  VERSION: () => VERSION,
  createSAMEngine: () => createSAMEngine,
...
var SAMReactContext = (0, import_react.createContext)(null);
function SAMProvider({
  ...
  const sendMessage = (0, import_react.useCallback)(async (message, additionalContext) => {
  ...
  const clearConversation = (0, import_react.useCallback)(async () => {
    if (!engine) return;
    try {
  ...
  const updateContext = (0, import_react.useCallback)((newContext) => {
    setContext((prev) => ({
      ...prev,
      ...newContext
    }));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SAMReactContext.Provider, { value, children });
}
function useSAM() {
  const context = (0, import_react.useContext)(SAMReactContext);
  if (!context) {
...
function SAMChat({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `sam-chat ${className}`, children: [
        ...
        children: [
          messages.map((message, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "sam-message-content", children: message.content }),
                message.role === "assistant" && message.metadata?.contextInsights && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "sam-message-insights", children: [
                  message.metadata.contextInsights.observation && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "sam-insight", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Observation:" }),
                    " ",
                    message.metadata.contextInsights.observation
                  ] }),
                  message.metadata.contextInsights.recommendation && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "sam-insight", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Recommendation:" }),
                    " ",
          ...
          isLoading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "sam-message sam-message-loading", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "sam-loading-indicator", children: "SAM is thinking..." }) }),
          error && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "sam-message sam-message-error", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "sam-error-content", children: [
            "Error: ",
            error
          ] }) }),
    ...
    showSuggestions && suggestions.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "sam-suggestions", children: suggestions.map((suggestion, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "button",
      {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "sam-chat-input", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "sam-chat-actions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            onClick: handleSend,
...
function SAMFloatingAssistant({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `fixed ${positionClasses[position]} z-50`, children: isOpen ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "sam-floating-panel", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "sam-floating-header", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SAMChat, { maxHeight: "300px", autoFocus: true })
  ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "button",
    {
