...
export function generateCourseContentHash(course: CourseData): string {
  const contentToHash = {
    title: course.title,
...
export class EnhancedDepthAnalysisEngine {
  ...
  private async storeAnalysis(
    ...
    try {
      const payload: CourseDepthAnalysisCacheEntry = {
        courseId,
        contentHash,
        analyzedAt: new Date(),
...
export const createEnhancedDepthAnalysisEngine = (options?: EnhancedDepthAnalysisEngineOptions) =>
  new EnhancedDepthAnalysisEngine(options);
