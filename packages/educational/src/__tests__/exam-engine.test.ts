...
import type { ExamEngineConfig, ExamGenerationConfig } from '../types';
...
function createExamEngineConfig(
  overrides: Partial<ExamEngineConfig> = {}
): ExamEngineConfig {
  return {
...
function createExamGenerationConfig(
  overrides: Partial<ExamGenerationConfig> = {}
...
describe('AdvancedExamEngine', () => {
  let engine: AdvancedExamEngine;
  let config: ExamEngineConfig;
