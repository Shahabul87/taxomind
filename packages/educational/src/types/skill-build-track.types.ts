...
export interface CompositeScoreWeights {
  mastery: number;      // Default: 0.35
  retention: number;    // Default: 0.25
  application: number;  // Default: 0.25
  confidence: number;   // Default: 0.08
  calibration: number;  // Default: 0.07
}
 ...
 * 7-level proficiency framework (Dreyfus + SFIA hybrid)
 */
export type SkillBuildProficiencyLevel =
  | 'NOVICE'      // 0-14:  Basic awareness, follows instructions
  | 'BEGINNER'    // 15-34: Limited experience, requires guidance
  | 'COMPETENT'   // 35-54: Works independently on routine tasks
  | 'PROFICIENT'  // 55-69: Handles complex tasks, applies theory
  | 'ADVANCED'    // 70-84: Deep expertise, mentors others
  | 'EXPERT'      // 85-94: Recognized authority in the field
  | 'STRATEGIST'; // 95-100: Industry leader, sets direction

/**
 * Level thresholds for score-to-level mapping
 */
export const PROFICIENCY_THRESHOLDS: Record<SkillBuildProficiencyLevel, number> = {
  NOVICE: 0,
  BEGINNER: 15,
  COMPETENT: 35,
  PROFICIENT: 55,
 ...
 */
export const DEFAULT_DECAY_RATES: Record<SkillBuildProficiencyLevel, number> = {
...
export type SkillBuildFramework =
  | 'SFIA'        // Skills Framework for the Information Age
  | 'ONET'        // O*NET (US Department of Labor)
...
export type SkillBuildCategory =
  | 'TECHNICAL'       // Hard/technical skills
  | 'SOFT'            // Interpersonal/soft skills
  | 'DOMAIN'          // Domain-specific knowledge
  | 'TOOL'            // Tool/technology proficiency
  | 'METHODOLOGY'     // Process/methodology skills
  | 'CERTIFICATION'   // Certification-based competencies
  | 'LEADERSHIP';     // Leadership and management skills

export type SkillBuildTrend =
  | 'ACCELERATING'  // Learning speed increasing
  | 'STEADY'        // Consistent progress
  | 'SLOWING'       // Learning speed decreasing
  | 'STAGNANT'      // No recent progress
  | 'DECLINING';    // Skill decay detected

export type SkillBuildEvidenceType =
  | 'ASSESSMENT'       // Formal assessment/test
  | 'PROJECT'          // Project completion
  | 'CERTIFICATION'    // External certification
  | 'COURSE_COMPLETION'// Course completion
  | 'PEER_REVIEW'      // Peer endorsement
  | 'SELF_ASSESSMENT'  // Self-reported
  | 'PRACTICE_SESSION' // Practice/exercise
  | 'REAL_WORLD'       // Real-world application
  | 'TEACHING';        // Teaching/mentoring others

export type SkillBuildRoadmapStatus =
  | 'DRAFT'
  | 'ACTIVE'
  | 'PAUSED'
  | 'COMPLETED'
...
export type SkillBuildMilestoneStatus =
  | 'LOCKED'
  | 'AVAILABLE'
  | 'IN_PROGRESS'
  | 'COMPLETED'
...
export type SkillBuildBenchmarkSource =
  | 'INDUSTRY'       // Industry-wide benchmarks
  | 'ROLE'           // Role-specific benchmarks
  | 'PEER_GROUP'     // Peer group comparison
...
// ============================================================================
// SKILL PROFILE TYPES (Multi-dimensional)
// ============================================================================
...
export interface GenerateRoadmapInput {
  ...
  targetId?: string;
  targetSkills?: { skillId: string; targetLevel: SkillBuildProficiencyLevel }[];
  targetCompletionDate?: Date;
  hoursPerWeek?: number;
...
// ============================================================================
// STORE INTERFACES (for portability)
// ============================================================================
