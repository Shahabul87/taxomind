...
export type ProficiencyLevel =
  | 'NOVICE'          // 1 - Basic awareness
  | 'BEGINNER'        // 2 - Limited experience
  | 'COMPETENT'       // 3 - Practical application
  | 'PROFICIENT'      // 4 - Applied theory
  | 'EXPERT'          // 5 - Recognized authority
  | 'MASTER';         // 6 - Industry leader

export type SkillRelationType =
  | 'PREREQUISITE'    // Must have before
  | 'COREQUISITE'     // Should learn together
  | 'ENHANCES'        // Improves effectiveness of
  | 'RELATED'         // Generally related
  | 'SPECIALIZATION'  // More specific version
  | 'GENERALIZATION'; // Broader version
...
export type CompetencyAssessmentType =
  | 'QUIZ'
  | 'PRACTICAL'
  | 'CODE_CHALLENGE'
  | 'CASE_STUDY'
