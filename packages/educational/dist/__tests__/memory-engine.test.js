...
function createMemoryEngineConfig(overrides = {}) {
    return {
...
describe('MemoryEngine', () => {
    ...
    describe('conversation management', () => {
        it('should throw error for initializeConversation without database', async () => {
            await expect(engine.initializeConversation()).rejects.toThrow('Database adapter is required');
        });
        it('should throw error for addMessageWithMemory without database', async () => {
            await expect(engine.addMessageWithMemory('user', 'Hello')).rejects.toThrow('Database adapter is required');
        });
