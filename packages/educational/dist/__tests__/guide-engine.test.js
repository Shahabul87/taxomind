...
// ============================================================================
function createGuideEngineConfig(overrides = {}) {
    return {
        ...overrides,
    };
}
...
describe('CourseGuideEngine', () => {
    ...
    describe('generateCourseGuide', () => {
        it('should throw error without database adapter', async () => {
            await expect(engine.generateCourseGuide('course-1')).rejects.toThrow('Database adapter is required for course guide generation');
        });
        it('should throw error without database adapter with options', async () => {
            await expect(engine.generateCourseGuide('course-1', true, true)).rejects.toThrow('Database adapter is required for course guide generation');
        });
    });
    // ============================================================================
    ...
    describe('exportCourseGuide', () => {
        it('should throw error without database adapter', async () => {
            await expect(engine.exportCourseGuide('course-1')).rejects.toThrow('Database adapter is required for course guide generation');
        });
    });
    // ============================================================================
    // EDGE CASES
