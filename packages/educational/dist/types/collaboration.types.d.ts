...
export type CollaborationActivityType = 'discussion' | 'co-creation' | 'peer-review' | 'brainstorming' | 'problem-solving' | 'presentation' | 'q&a';
export type CollaborationContributionType = 'message' | 'question' | 'answer' | 'resource' | 'edit' | 'reaction';
...
//# sourceMappingURL=collaboration.types.d.ts.map