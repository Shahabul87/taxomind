 ...
 */
export type PracticeProblemType = 'multiple_choice' | 'short_answer' | 'coding' | 'essay' | 'fill_blank' | 'matching' | 'ordering' | 'diagram' | 'calculation' | 'case_study';
/**
...
export interface PracticeSessionStats {
    ...
    byBloomsLevel: Record<BloomsLevel, {
        attempts: number;
        correct: number;
    }>;
...
//# sourceMappingURL=practice-problems.types.d.ts.map