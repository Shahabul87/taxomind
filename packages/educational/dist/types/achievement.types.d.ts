...
export type AchievementCategory = 'learning' | 'teaching' | 'collaboration' | 'consistency' | 'mastery' | 'creativity';
...
export type ChallengeRequirementType = 'create_content' | 'use_ai' | 'form_completion' | 'streak_maintenance' | 'collaboration' | 'improvement';
