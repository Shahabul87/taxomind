 ...
 */
export type PeerProficiencyLevel = 'BEGINNER' | 'INTERMEDIATE' | 'ADVANCED' | 'EXPERT' | 'MASTER';
/**
...
export type BadgeCategory = 'HELPER' | 'COLLABORATOR' | 'MENTOR' | 'LEARNER' | 'CONTRIBUTOR' | 'LEADER' | 'SPECIALIST';
...
export type ReputationCategory = 'SESSION_COMPLETED' | 'POSITIVE_FEEDBACK' | 'NEGATIVE_FEEDBACK' | 'ANSWER_ACCEPTED' | 'BADGE_EARNED' | 'PROJECT_COMPLETED' | 'NO_SHOW' | 'ENDORSEMENT_RECEIVED';
/**
 * Peer match result
 */
...
export type MatchType = 'STUDY_PARTNER' | 'MENTOR' | 'MENTEE' | 'PROJECT_COLLABORATOR' | 'TUTOR' | 'TUTEE' | 'ANY';
/**
...
export type GroupType = 'STUDY_GROUP' | 'LEARNING_CIRCLE' | 'COHORT' | 'PROJECT_TEAM' | 'BOOK_CLUB' | 'ACCOUNTABILITY_GROUP';
...
export type PeerResourceType = 'DOCUMENT' | 'VIDEO' | 'AUDIO' | 'LINK' | 'NOTE' | 'CODE' | 'PRESENTATION' | 'SPREADSHEET' | 'OTHER';
/**
 * Group study session
 */
...
export type GroupSessionType = 'STUDY_SESSION' | 'DISCUSSION' | 'PRESENTATION' | 'WORKSHOP' | 'Q_AND_A' | 'REVIEW' | 'BRAINSTORM' | 'PRACTICE';
...
export type ReactionType = 'LIKE' | 'HELPFUL' | 'INSIGHTFUL' | 'CELEBRATE' | 'CONFUSED' | 'QUESTION';
/**
...
export type MentorshipType = 'FORMAL' | 'INFORMAL' | 'PEER_MENTORING' | 'GROUP_MENTORING' | 'REVERSE_MENTORING';
/**
 * Mentor profile
 */
...
export type MentoringStyle = 'DIRECTIVE' | 'SUPPORTIVE' | 'COACHING' | 'DELEGATING' | 'COLLABORATIVE';
...
export type MentoringSessionType = 'REGULAR' | 'GOAL_SETTING' | 'PROGRESS_REVIEW' | 'SKILL_DEVELOPMENT' | 'CAREER_GUIDANCE' | 'PROBLEM_SOLVING' | 'FINAL_REVIEW';
...
export type PeerReviewType = 'SINGLE_BLIND' | 'DOUBLE_BLIND' | 'OPEN' | 'COLLABORATIVE';
export type ReviewAssignmentStatus = 'ASSIGNED' | 'IN_PROGRESS' | 'SUBMITTED' | 'CALIBRATED' | 'LATE' | 'EXEMPTED';
/**
...
export type ProjectType = 'RESEARCH' | 'CODING' | 'DESIGN' | 'WRITING' | 'PRESENTATION' | 'CASE_STUDY' | 'CAPSTONE' | 'HACKATHON';
export type ProjectStatus = 'PLANNING' | 'IN_PROGRESS' | 'UNDER_REVIEW' | 'COMPLETED' | 'ON_HOLD' | 'CANCELLED';
/**
 * Project team
 */
...
export type MilestoneStatus = 'PENDING' | 'IN_PROGRESS' | 'UNDER_REVIEW' | 'COMPLETED' | 'OVERDUE';
...
//# sourceMappingURL=peer-learning.types.d.ts.map