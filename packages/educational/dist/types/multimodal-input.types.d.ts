 ...
 */
export type MultimodalInputType = 'IMAGE' | 'VOICE' | 'HANDWRITING' | 'VIDEO' | 'DIAGRAM' | 'EQUATION' | 'CODE_SCREENSHOT' | 'DOCUMENT_SCAN';
/**
 * Processing status for multimodal inputs
 */
export type MultimodalProcessingStatus = 'PENDING' | 'PROCESSING' | 'COMPLETED' | 'FAILED' | 'REQUIRES_REVIEW' | 'PARTIALLY_PROCESSED';
/**
 * Quality level of processed input
 */
export type MultimodalQualityLevel = 'EXCELLENT' | 'GOOD' | 'ACCEPTABLE' | 'POOR' | 'UNREADABLE';
/**
 * Language support for voice/text recognition
 */
export type MultimodalLanguage = 'en' | 'es' | 'fr' | 'de' | 'zh' | 'ja' | 'ko' | 'ar' | 'hi' | 'pt' | 'ru' | 'it' | 'other';
/**
 * Types of image content for classification
 */
export type ImageContentType = 'DIAGRAM' | 'CHART' | 'GRAPH' | 'PHOTOGRAPH' | 'SCREENSHOT' | 'HANDWRITTEN_TEXT' | 'PRINTED_TEXT' | 'EQUATION' | 'MAP' | 'ILLUSTRATION' | 'TABLE' | 'CODE' | 'MIXED' | 'UNKNOWN';
/**
 * Types of voice content
 */
export type VoiceContentType = 'SPEECH' | 'LECTURE' | 'READING' | 'QUESTION_ANSWER' | 'DISCUSSION' | 'PRESENTATION' | 'DICTATION' | 'FOREIGN_LANGUAGE' | 'MUSIC' | 'OTHER';
/**
 * Types of handwriting
 */
export type HandwritingType = 'CURSIVE' | 'PRINT' | 'MIXED' | 'SHORTHAND' | 'CALLIGRAPHY' | 'SYMBOLS' | 'EQUATIONS' | 'DIAGRAMS';
/**
 * Assessment context for multimodal input
 */
export type MultimodalAssessmentContext = 'EXAM' | 'HOMEWORK' | 'PRACTICE' | 'PROJECT' | 'LAB_REPORT' | 'ESSAY' | 'PRESENTATION' | 'QUIZ' | 'PORTFOLIO' | 'SELF_ASSESSMENT';
/**
 * Accessibility requirements
 */
export type AccessibilityRequirement = 'SCREEN_READER' | 'HIGH_CONTRAST' | 'LARGE_TEXT' | 'AUDIO_DESCRIPTION' | 'CAPTIONS' | 'SIGN_LANGUAGE' | 'SIMPLIFIED_INTERFACE' | 'KEYBOARD_ONLY';
/**
 ...
 * Types of diagrams
 */
export type DiagramType = 'FLOWCHART' | 'UML' | 'ER_DIAGRAM' | 'NETWORK' | 'ORGANIZATIONAL' | 'VENN' | 'TREE' | 'MIND_MAP' | 'SEQUENCE' | 'STATE' | 'CIRCUIT' | 'CHEMISTRY' | 'BIOLOGY' | 'PHYSICS' | 'MATH' | 'GEOGRAPHIC' | 'OTHER';
/**
 * Diagram component
 */
 ...
 * Types of equations
 */
export type EquationType = 'ALGEBRAIC' | 'CALCULUS' | 'DIFFERENTIAL' | 'TRIGONOMETRIC' | 'STATISTICAL' | 'MATRIX' | 'SET_THEORY' | 'LOGIC' | 'CHEMICAL' | 'PHYSICS' | 'OTHER';
/**
 ...
 * Event types
 */
export type MultimodalEventType = 'processing.started' | 'processing.completed' | 'processing.failed' | 'quality.assessed' | 'accessibility.generated' | 'assessment.graded' | 'file.uploaded' | 'file.deleted';
/**
...
//# sourceMappingURL=multimodal-input.types.d.ts.map