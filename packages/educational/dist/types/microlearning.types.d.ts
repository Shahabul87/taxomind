...
export type MicroModuleType = 'CONCEPT' | 'PRACTICE' | 'QUIZ' | 'FLASHCARD' | 'VIDEO_SNIPPET' | 'INTERACTIVE' | 'SUMMARY' | 'REFLECTION';
export type MicrolearningContentFormat = 'TEXT' | 'RICH_TEXT' | 'MARKDOWN' | 'HTML' | 'VIDEO' | 'AUDIO' | 'IMAGE' | 'INTERACTIVE';
export type DeviceType = 'MOBILE' | 'TABLET' | 'DESKTOP';
export type DeliveryScheduleType = 'SPACED_REPETITION' | 'DAILY_DIGEST' | 'ADAPTIVE' | 'ON_DEMAND' | 'NOTIFICATION';
export type MicroModuleStatus = 'NOT_STARTED' | 'IN_PROGRESS' | 'COMPLETED' | 'SKIPPED' | 'NEEDS_REVIEW';
/**
...
//# sourceMappingURL=microlearning.types.d.ts.map