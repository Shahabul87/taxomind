 ...
 */
export type ContentFormat = 'text' | 'video' | 'audio' | 'diagram' | 'infographic' | 'interactive' | 'simulation' | 'quiz' | 'code_example' | 'case_study';
/**
...
//# sourceMappingURL=adaptive-content.types.d.ts.map