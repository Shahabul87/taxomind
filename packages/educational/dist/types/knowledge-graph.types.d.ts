...
export type ConceptType = 'FOUNDATIONAL' | 'PROCEDURAL' | 'CONCEPTUAL' | 'METACOGNITIVE';
export type RelationType = 'PREREQUISITE' | 'SUPPORTS' | 'EXTENDS' | 'RELATED' | 'CONTRASTS';
export type ConceptMasteryLevel = 'NOT_STARTED' | 'INTRODUCED' | 'PRACTICING' | 'PROFICIENT' | 'MASTERED';
/**
...
//# sourceMappingURL=knowledge-graph.types.d.ts.map