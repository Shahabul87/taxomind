...
import { createRouteHandlerFactory, createErrorResponse, createSuccessResponse, generateRequestId, } from '../utils/factory';
// ============================================================================
// TEST FIXTURES
// ============================================================================
...
describe('createRouteHandlerFactory', () => {
    ...
    describe('createHandler', () => {
        ...
        it('should call onRequest callback', async () => {
            ...
            expect(onRequest).toHaveBeenCalledWith(request, expect.objectContaining({
        ...
        it('should call onResponse callback', async () => {
            ...
            const request = createMockRequest();
            await wrappedHandler(request);
            expect(onResponse).toHaveBeenCalledWith(response, expect.objectContaining({ requestId: expect.stringMatching(/^req_/) }));
        });
