 ...
 */
export function createRouteHandlerFactory(options) {
    const { config, defaultRateLimit, authenticate, onError, onRequest, onResponse, } = options;
            ...
            try {
                ...
                if (rateLimitConfig && rateLimiter) {
                    ...
                    if (rateLimitResult.blocked) {
                        return createErrorResponse(429, 'RATE_LIMITED', rateLimitConfig.message ?? 'Too many requests', {
                ...
                return createErrorResponse(500, 'INTERNAL_ERROR', 'An unexpected error occurred', process.env.NODE_ENV === 'development'
