...
import { EvaluationMemoryIntegrationImpl, createEvaluationMemoryIntegration, InMemoryMemoryStore, } from '../evaluation-memory-integration';
import { InMemoryStudentProfileStore } from '../student-profile-store';
import { InMemoryReviewScheduleStore } from '../spaced-repetition';
import { createSampleEvaluationOutcome, createSampleStudentProfile, createSampleLearningPathway, } from './setup';
describe('EvaluationMemoryIntegrationImpl', () => {
    ...
    describe('getRelevantMemories', () => {
        ...
        it('should deduplicate memories', async () => {
            ...
            for (let i = 0; i < 3; i++) {
                await integration.recordEvaluationOutcome(createSampleEvaluationOutcome({
                    studentId: 'student-1',
                    topicId: 'topic-1',
                    score: 85 + i,
                }));
...
//# sourceMappingURL=evaluation-memory-integration.test.js.map