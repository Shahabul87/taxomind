...
import { MasteryTracker, createMasteryTracker, DEFAULT_MASTERY_TRACKER_CONFIG, } from '../mastery-tracker';
import { InMemoryStudentProfileStore } from '../student-profile-store';
import { createSampleEvaluationOutcome, createSampleStudentProfile, createSampleTopicMastery, } from './setup';
describe('MasteryTracker', () => {
    ...
    describe('processEvaluation', () => {
        ...
        it('should generate challenge recommendation for high mastery', async () => {
            ...
            expect(result.recommendations.some((r) => r.type === 'challenge_increase' || r.type === 'maintain')).toBe(true);
        });
    ...
    describe('getMasterySummary', () => {
        ...
        it('should include level distribution', async () => {
            ...
            const totalInDistribution = Object.values(result.levelDistribution).reduce((sum, count) => sum + count, 0);
...
//# sourceMappingURL=mastery-tracker.test.js.map