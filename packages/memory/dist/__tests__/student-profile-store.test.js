...
import { InMemoryStudentProfileStore, createInMemoryStudentProfileStore, getDefaultStudentProfileStore, resetDefaultStudentProfileStore, } from '../student-profile-store';
import { createSampleStudentProfile, createSampleMasteryUpdate, createSampleLearningPathway, createSamplePathwayStep, } from './setup';
describe('InMemoryStudentProfileStore', () => {
    ...
    describe('updatePathway', () => {
        it('should throw error when student not found', async () => {
            ...
            await expect(store.updatePathway('non-existent', 'pathway-1', adjustment)).rejects.toThrow('Student profile not found');
        });
        it('should throw error when pathway not found', async () => {
            ...
            await expect(store.updatePathway('student-1', 'non-existent', adjustment)).rejects.toThrow('Pathway not found');
        });
    ...
    describe('updateMetrics', () => {
        it('should throw error for non-existent profile', async () => {
            await expect(store.updateMetrics('non-existent', { currentStreak: 5 })).rejects.toThrow('Student profile not found');
        });
...
//# sourceMappingURL=student-profile-store.test.js.map