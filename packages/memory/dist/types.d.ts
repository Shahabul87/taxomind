 ...
 */
export declare const DEFAULT_SPACED_REPETITION_CONFIG: Required<SpacedRepetitionConfig>;
/**
 ...
 * Memory entry type
 */
export type MemoryEntryType = 'EVALUATION_OUTCOME' | 'MASTERY_UPDATE' | 'PATHWAY_CHANGE' | 'LEARNING_MILESTONE' | 'STRUGGLE_POINT' | 'BREAKTHROUGH';
/**
 ...
 */
export declare const DEFAULT_MEMORY_INTEGRATION_CONFIG: Required<MemoryIntegrationConfig>;
/**
