 ...
 */
export declare const BLOOMS_LEVEL_ORDER: BloomsLevel[];
/**
 * Get numeric index of a Bloom's level (0-5)
 */
export declare function getBloomsLevelIndex(level: BloomsLevel): number;
/**
 ...
 */
export declare const BLOOMS_SUB_LEVEL_ORDER: BloomsSubLevel[];
/**
 * Get numeric index of a sub-level (0-2)
 */
export declare function getBloomsSubLevelIndex(subLevel: BloomsSubLevel): number;
/**
 ...
 */
export declare function calculateBloomsNumericScore(levelOrName: number | BloomsLevel, subLevel: BloomsSubLevel): number;
/**
 * Determine sub-level from indicator scores
 * @param indicators - Array of sub-level indicators
 * @returns The determined sub-level
 */
export declare function determineSubLevelFromIndicators(indicators: SubLevelIndicator[]): BloomsSubLevel;
/**
 * Create a human-readable label for the Bloom's level and sub-level
 */
export declare function createBloomsLabel(level: BloomsLevel, subLevel: BloomsSubLevel): string;
/**
 ...
 */
export declare const DIFFICULTY_LEVEL_ORDER: DifficultyLevel[];
/**
 * Get numeric index of difficulty level (0-3)
 */
export declare function getDifficultyLevelIndex(level: DifficultyLevel): number;
/**
 ...
 */
export type GradualReleasePhase = 'I_DO' | 'WE_DO' | 'YOU_DO_TOGETHER' | 'YOU_DO_ALONE';
/**
 ...
 */
export type ZPDZone = 'TOO_EASY' | 'COMFORT_ZONE' | 'ZPD_LOWER' | 'ZPD_OPTIMAL' | 'ZPD_UPPER' | 'FRUSTRATION' | 'UNREACHABLE';
/**
 ...
 */
export declare const DEFAULT_PEDAGOGICAL_PIPELINE_CONFIG: Required<PedagogicalPipelineConfig>;
/**
