...
import { createContextDetector, contextDetector, getCapabilities, hasCapability, } from '../utils/contextDetector';
// ============================================================================
// TEST FIXTURES
// ============================================================================
function createMockContext(pageType = 'dashboard', capabilities = []) {
    return {
        user: {
            id: 'user-1',
            role: 'student',
