 ...
 */
import type { ExecutionPlan, PlanStep, PlanState, StepType, StepResult, LearningGoal } from '../goal-planning/types';
...
export type InterventionType = 'encouragement' | 'difficulty_adjustment' | 'content_recommendation' | 'break_suggestion' | 'goal_revision' | 'progress_check' | 'struggle_detection' | 'milestone_celebration';
...
export type TransitionType = 'advance' | 'skip' | 'retry' | 'rollback' | 'jump' | 'complete' | 'pause' | 'resume';
