...
import { DEFAULT_CONNECTION_CONFIG, ConnectionState as ConnectionStateConst, SAMEventType as SAMEventTypeConst, } from './types';
// ============================================================================
...
export class ClientWebSocketManager {
    ...
    logger;
    socket = null;
    state = ConnectionStateConst.DISCONNECTED;
    connectionId = null;
    userId = null;
    metadata = null;
    reconnectAttempts = 0;
...
export class ServerConnectionManager {
    ...
    // Connection Management
    // ---------------------------------------------------------------------------
    registerConnection(connectionId, userId, socket, // WebSocket type varies by environment
    metadata) {
        const connection = {
            id: connectionId,
            userId,
