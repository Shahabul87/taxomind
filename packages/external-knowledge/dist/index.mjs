// src/types.ts
import { z } from "zod";
var ExternalSourceTypeSchema = z.enum([
  "news",
  "research",
  "documentation",
  "tutorial",
...
var ContentQualitySchema = z.enum(["high", "medium", "low", "unknown"]);
var ExternalContentSchema = z.object({
  id: z.string(),
...
var NewsSourceTypeSchema = z2.enum([
  "official",
  "research",
  "media",
  "blog",
...
var ImpactLevelSchema = z2.enum(["low", "medium", "high", "critical"]);
var TechnicalDepthSchema = z2.enum([
  "beginner",
  "intermediate",
  "advanced",
  "expert"
]);
var NewsCategorySchema = z2.enum([
  "breakthrough",
  "research",
  "industry",
  "policy",
