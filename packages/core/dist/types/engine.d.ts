...
export declare const BLOOMS_LEVELS: BloomsLevel[];
export declare const BLOOMS_LEVEL_ORDER: Record<BloomsLevel, number>;
...
export type AnalysisType = 'blooms' | 'content' | 'assessment' | 'personalization' | 'course-structure' | 'learning-path' | 'performance' | 'engagement';
...
export type ContentType = 'chapter' | 'section' | 'lesson' | 'quiz' | 'exercise' | 'summary' | 'explanation' | 'example';
