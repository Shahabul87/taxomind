...
export type LinkCategory = 'navigation' | 'action' | 'external' | 'resource' | 'breadcrumb' | 'pagination';
...
export declare const CONTEXT_SNAPSHOT_VERSION = "1.0.0";
...
export declare function createDefaultPageState(): PageState;
export declare function createDefaultContentSnapshot(): ContentSnapshot;
export declare function createDefaultNavigationSnapshot(): NavigationSnapshot;
export declare function createDefaultInteractionSnapshot(): InteractionSnapshot;
export declare function createDefaultPageContextSnapshot(partial?: Partial<PageContextSnapshot>): PageContextSnapshot;
