...
type SAMPageType = 'dashboard' | 'user-dashboard' | 'admin-dashboard' | 'teacher-dashboard' | 'user-analytics' | 'courses-list' | 'course-detail' | 'course-create' | 'chapter-detail' | 'section-detail' | 'analytics' | 'learning' | 'course-learning' | 'chapter-learning' | 'section-learning' | 'exam' | 'exam-results' | 'settings' | 'other';
...
type FormPurpose = 'create' | 'edit' | 'search' | 'filter' | 'settings' | 'unknown';
...
type LinkCategory = 'navigation' | 'action' | 'external' | 'resource' | 'breadcrumb' | 'pagination';
...
declare const CONTEXT_SNAPSHOT_VERSION = "1.0.0";
...
interface ContextGatheringInput {
...
interface ContextGatheringOutput {
    snapshot: PageContextSnapshot;
    pageSummary: string;
    formSummary: string;
...
interface UseContextGatheringOptions {
    enabled?: boolean;
    debounceMs?: number;
...
interface UseContextGatheringReturn {
...
declare function createDefaultPageState(): PageState;
declare function createDefaultContentSnapshot(): ContentSnapshot;
declare function createDefaultNavigationSnapshot(): NavigationSnapshot;
declare function createDefaultInteractionSnapshot(): InteractionSnapshot;
declare function createDefaultPageContextSnapshot(partial?: Partial<PageContextSnapshot>): PageContextSnapshot;
...
declare class ContextGatheringEngine extends BaseEngine<ContextGatheringInput, ContextGatheringOutput> {
    constructor(config: SAMConfig);
...
declare function createContextGatheringEngine(config: SAMConfig): ContextGatheringEngine;
 ...
 */
interface ContextMemoryLogger {
    info(message: string, data?: Record<string, unknown>): void;
    warn(message: string, data?: Record<string, unknown>): void;
    error(message: string, data?: Record<string, unknown>): void;
}
interface ContextMemoryHydratorOptions {
...
declare class ContextMemoryHydrator {
...
declare class InMemoryContextMemoryAdapter implements ContextMemoryAdapter {
...
declare function createContextMemoryHydrator(options: ContextMemoryHydratorOptions): ContextMemoryHydrator;
declare function createInMemoryContextMemoryAdapter(): InMemoryContextMemoryAdapter;
...
export { type AIAdapter, type AIChatParams, type AIChatResponse, type AIChatStreamChunk, AIError, type AIMessage, type AggregatedResponse, type AnalysisRequest, type AnalysisResponse, type AnalysisType, type AnalyticsAdapter, type AnalyticsEvent, type AnalyzeEvent, AnthropicAdapter, type AnthropicAdapterOptions, type AssessmentAnalysis, type AssessmentConfig, AssessmentEngine, type AssessmentEngineOutput, type AssessmentRequest, type AssessmentResponse, BLOOMS_LEVELS, BLOOMS_LEVEL_ORDER, type BadgeData, BaseEngine, type BaseEngineOptions, type BloomsAnalysis, type BloomsDistribution, BloomsEngine, type BloomsEngineInput, type BloomsEngineOutput, type BloomsLevel, CONTEXT_SNAPSHOT_VERSION, type CacheAdapter, CacheError, type CognitiveLoad, type CognitiveLoadProfile, ConfigurationError, type ContentAdaptation, type ContentCodeBlock, ContentEngine, type ContentEngineOutput, type ContentHeading, type ContentImage, type ContentMetrics, type ContentSnapshot, type ContentSuggestion, type ContentTable, type ContentType, type ContextDiff, ContextEngine, type ContextEngineOutput, ContextGatheringEngine, type ContextGatheringInput, type ContextGatheringOutput, type ContextMemoryAdapter, ContextMemoryHydrator, type ContextMemoryHydratorOptions, type ContextMemoryLogger, type ContextProvider, type ConversationData, type CountResult, type DatabaseAdapterOptions, DeepSeekAdapter, type DeepSeekAdapterOptions, DependencyError, type EmotionalProfile, type EmotionalState, type EngineConfig, EngineError, type EngineErrorInfo, type EngineInput, type EngineRegistration, type EngineResult, type EngineResultData, type EngineResultMetadata, type EntityContextData, type ErrorEvent, type ExecuteActionEvent, type FieldDependency, type FieldGroup, type FormFieldSnapshot, type FormPurpose, type FormSnapshot, type GamificationData, type GeneratedContent, type GeneratedQuestion, type GenerationRequest, type GenerationResponse, type HydrationResult, InMemoryContextMemoryAdapter, InMemoryDatabaseAdapter, type InMemoryDatabaseOptions, InitializationError, type InteractionData, type InteractionSnapshot, type KnowledgeGraphInterface, type LearningPathNode, type LearningProfileData, type LearningStyleProfile, type LinkCategory, MemoryCacheAdapter, type MemoryCacheOptions, type MemoryDirectives, type MotivationProfile, type NavigationLink, type NavigationSnapshot, NoopDatabaseAdapter, OpenAIAdapter, type OpenAIAdapterOptions, OrchestrationError, type OrchestrationMetadata, type OrchestrationOptions, type OrchestrationResult, type PageContextSnapshot, type PageSnapshot, type PageState, type PaginationState, PersonalizationEngine, type PersonalizationEngineOutput, type PersonalizedLearningPath, type QueryIntent, type QueryOptions, type Question, type QuestionOption, type QuestionType, RateLimitError, type ReceiveResponseEvent, type RelatedEntity, ResponseEngine, type ResponseEngineOutput, type SAMAchievement, type SAMAction, SAMAgentOrchestrator, type SAMBadge, type SAMBadgeLevel, type SAMBloomsProgress, type SAMChapter, type SAMCognitiveProgress, type SAMConfig, type SAMConfigInput, type SAMContext, type SAMContextMetadata, type SAMConversationContext, type SAMCourse, type SAMCourseAnalysis, type SAMDatabaseAdapter, type SAMEmotion, type SAMEngineSettings, SAMError, type SAMErrorCode, type SAMErrorDetails, type SAMEvent, type SAMEventType, type SAMFeatureFlags, type SAMFormContext, type SAMFormField, type SAMGamificationContext, type SAMInteractionLog, type SAMLearningStyle, type SAMLogger, type SAMMessage, type SAMMessageMetadata, type SAMMessageRole, type SAMModelConfig, type SAMPageContext, type SAMPageType, type SAMPosition, type SAMQuestion, type SAMRateLimitConfig, type SAMRoutePatterns, type SAMSection, type SAMSize, type SAMState, type SAMStateListener, SAMStateMachine, type SAMStreak, type SAMSuggestion, type SAMTeachingMethod, type SAMTheme, type SAMTone, type SAMUIContext, type SAMUser, type SAMUserContext, type SAMUserPreferences, type SAMUserRole, type SendMessageEvent, type SessionContextInterface, type SidebarItem, type StorageAdapter, StorageError, type StreamChunkEvent, type StudyGuide, type TabItem, TimeoutError, type TransactionContext, type UpdateContextEvent, type UpdateFormEvent, type UpdateGamificationEvent, type UpdatePageEvent, type UseContextGatheringOptions, type UseContextGatheringReturn, type UserProfileData, VERSION, ValidationError, type ValidationRule, type ValidationState, type VectorStoreInterface, createAnthropicAdapter, createAssessmentEngine, createBloomsEngine, createContentEngine, createContextEngine, createContextGatheringEngine, createContextMemoryHydrator, createDeepSeekAdapter, createDefaultContentSnapshot, createDefaultContext, createDefaultConversationContext, createDefaultGamificationContext, createDefaultInteractionSnapshot, createDefaultNavigationSnapshot, createDefaultPageContext, createDefaultPageContextSnapshot, createDefaultPageState, createDefaultUIContext, createDefaultUserContext, createInMemoryContextMemoryAdapter, createInMemoryDatabase, createMemoryCache, createNoopDatabaseAdapter, createOpenAIAdapter, createOrchestrator, createPersonalizationEngine, createResponseEngine, createSAMConfig, createStateMachine, createTimeoutPromise, isSAMError, withRetry, withTimeout, wrapError };
