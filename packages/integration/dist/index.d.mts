import { z } from 'zod';
import { DatabaseAdapter, RepositoryFactory, AuthAdapter, AuthContextProvider, PermissionChecker, VectorAdapter, EmbeddingAdapter, VectorService, AIAdapter, AIService, NotificationAdapter, NotificationService, RealtimeAdapter, SAMRealtimeService } from './adapters/index.mjs';
...
import { AIAdapter as AIAdapter$1 } from '@sam-ai/core';
import { EmbeddingProvider } from '@sam-ai/agentic';
...
declare function createCoreAIAdapterFromIntegration(adapter: AIAdapter, options?: {
    model?: string;
}): AIAdapter$1;

declare function createEmbeddingProviderFromIntegration(adapter: EmbeddingAdapter): EmbeddingProvider;
