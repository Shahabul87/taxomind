 ...
 */
import { RuntimeEnvironment, HostFrameworkType, DatabaseType, VectorAdapterType, AuthProviderType, AIProviderType, EmbeddingProviderType, RealtimeType, DataSourceType, } from '../types/profile';
// ============================================================================
// HOST DETECTOR
// ============================================================================
/**
...
export class HostDetector {
    ...
    detectFeatures() {
        ...
        if (typeof process !== 'undefined' && process.env) {
            ...
            // Auth
            features.hasNextAuth = !!(process.env.NEXTAUTH_URL ||
                process.env.AUTH_SECRET ||
                process.env.NEXTAUTH_SECRET);
            features.hasClerk = !!(process.env.CLERK_SECRET_KEY ||
                process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY);
            // AI
            features.hasAnthropic = !!process.env.ANTHROPIC_API_KEY;
            features.hasOpenAI = !!process.env.OPENAI_API_KEY;
            // Redis
            features.hasRedis = !!(process.env.REDIS_URL ||
    ...
    detectEnvironment() {
        ...
        if (typeof process !== 'undefined' && process.env) {
            ...
            // Database
            env.hasDatabase = !!(process.env.DATABASE_URL ||
                process.env.POSTGRES_URL ||
                process.env.MYSQL_URL ||
                process.env.MONGODB_URI);
            // Auth
            env.hasAuth = !!(process.env.NEXTAUTH_URL ||
                process.env.AUTH_SECRET ||
                process.env.CLERK_SECRET_KEY);
            // AI
            env.hasAI = !!(process.env.ANTHROPIC_API_KEY ||
 ...
 */
export function generateProfileFromHost(options) {
    const detector = createHostDetector();
