 ...
 */
const RACIAL_ETHNIC_BIAS_PATTERNS = [
    {
 ...
 */
const DISABILITY_BIAS_PATTERNS = [
    {
 ...
 */
const NEURODIVERSITY_BIAS_PATTERNS = [
    {
 ...
 */
const EDUCATIONAL_BIAS_PATTERNS = [
    {
 ...
 */
export function createBiasDetector(config) {
    return new BiasDetector(config);
}
/**
 * Create strict bias detector (low confidence threshold)
 */
export function createStrictBiasDetector(config) {
 ...
 */
export function createLenientBiasDetector(config) {
    return new BiasDetector({
        ...config,
        minConfidence: 0.8,
    });
 ...
 */
export function createCategoryBiasDetector(categories, config) {
    return new BiasDetector({
        ...config,
