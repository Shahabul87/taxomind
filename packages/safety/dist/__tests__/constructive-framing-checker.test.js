...
import { ConstructiveFramingChecker, createConstructiveFramingChecker, createStrictConstructiveChecker, createLenientConstructiveChecker, DEFAULT_CONSTRUCTIVE_CONFIG, } from '../constructive-framing-checker';
// ============================================================================
...
describe('ConstructiveFramingChecker', () => {
    ...
    describe('check - constructive feedback', () => {
        ...
        it('should have few or no issues', () => {
            const result = checker.check(CONSTRUCTIVE_FEEDBACK);
            const criticalIssues = result.issues.filter(i => i.type === 'fixed_mindset_language' || i.type === 'unbalanced_criticism');
    ...
    describe('check - fixed mindset language', () => {
        it('should detect fixed mindset language', () => {
            ...
            const fixedMindsetIssues = result.issues.filter(i => i.type === 'fixed_mindset_language');
    ...
    describe('check - growth mindset language', () => {
        ...
        it('should find encouragement elements', () => {
            const result = checker.check(GROWTH_MINDSET_FEEDBACK);
            const encouragementElements = result.positiveElements.filter(e => e.type === 'encouragement' || e.type === 'growth_acknowledgment');
    ...
    describe('check - unbalanced criticism', () => {
        it('should detect unbalanced criticism', () => {
            ...
            const unbalancedIssues = result.issues.filter(i => i.type === 'unbalanced_criticism');
    ...
    describe('check - encouragement', () => {
        it('should detect missing encouragement for low scores', () => {
            ...
            const missingEncouragement = result.issues.find(i => i.type === 'missing_encouragement');
    ...
    describe('issue types', () => {
        ...
        it('should include problematic text in issues', () => {
            const result = checker.check(FIXED_MINDSET_FEEDBACK);
            const fixedMindsetIssue = result.issues.find(i => i.type === 'fixed_mindset_language');
...
//# sourceMappingURL=constructive-framing-checker.test.js.map