...
import type { DiscouragingLanguageDetectorConfig } from '../discouraging-language-detector';
...
describe('DiscouragingLanguageDetector', () => {
  let detector: DiscouragingLanguageDetector;
  ...
  describe('constructor', () => {
    ...
    it('should create detector with custom config', () => {
      const config: DiscouragingLanguageDetectorConfig = {
        minSeverity: 'high',
      };
  ...
  describe('severity filtering', () => {
    ...
    it('should only include high/critical with lenient detector', () => {
      ...
      const hasNonHighSeverity = result.matches.some(
