...
export type ContentType = 'lesson' | 'explanation' | 'exercise' | 'quiz' | 'assessment' | 'summary' | 'tutorial' | 'example' | 'feedback' | 'answer';
...
export declare const DEFAULT_PIPELINE_CONFIG: QualityGatePipelineConfig;
export declare const DEFAULT_COMPLETENESS_CONFIG: CompletenessGateConfig;
export declare const DEFAULT_EXAMPLE_QUALITY_CONFIG: ExampleQualityGateConfig;
export declare const DEFAULT_DIFFICULTY_MATCH_CONFIG: DifficultyMatchGateConfig;
export declare const DEFAULT_STRUCTURE_CONFIG: StructureGateConfig;
export declare const DEFAULT_DEPTH_CONFIG: DepthGateConfig;
