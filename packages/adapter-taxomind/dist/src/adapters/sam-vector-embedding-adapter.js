...
function mapRecordToDocument(record, includeVector) {
    ...
    return {
        ...
        metadata: {
            ...
            custom: record.customMetadata ?? undefined,
        },
...
// ADAPTER
// ============================================================================
export class SAMVectorEmbeddingAdapter {
    prisma;
    connected = true;
    dimensions;
    embeddingProvider;
    ...
    async searchByVector(vector, options) {
        ...
        const results = records
            ...
            if (options.minScore !== undefined && result.score < options.minScore)
                return false;
            if (options.maxDistance !== undefined && result.distance > options.maxDistance)
                return false;
            return true;
        })
...
// FACTORY FUNCTIONS
// ============================================================================
export function createSAMVectorEmbeddingAdapter(prisma, options) {
    return new SAMVectorEmbeddingAdapter(prisma, options);
}
export function createTaxomindSAMVectorService(prisma, options) {
...
//# sourceMappingURL=sam-vector-embedding-adapter.js.map