 ...
 */
import { AdapterFactory, CapabilityRegistry, } from '@sam-ai/integration';
// ============================================================================
// EXPORTS
// ============================================================================
export * from './profile';
...
// ============================================================================
import { createTaxomindIntegrationProfile, TAXOMIND_PROFILE_ID, TAXOMIND_PROFILE_VERSION, } from './profile/taxomind-profile';
 ...
 */
export function initializeTaxomindIntegration(options) {
 ...
 */
export function getTaxomindIntegration() {
    if (!_integrationContext) {
        throw new Error('Taxomind integration not initialized. Call initializeTaxomindIntegration first.');
    }
 ...
 */
export function setTaxomindIntegration(context) {
    _integrationContext = context;
}
/**
 * Initialize and set the singleton context
 */
export function bootstrapTaxomindIntegration(options) {
