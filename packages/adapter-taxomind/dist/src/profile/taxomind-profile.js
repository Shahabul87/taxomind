 ...
 */
import { DatabaseType, VectorAdapterType, AuthProviderType, AIProviderType, EmbeddingProviderType, RealtimeType, RuntimeEnvironment, HostFrameworkType, DataSourceType, ToolPermissionLevel, } from '@sam-ai/integration';
// ============================================================================
 ...
 */
export const taxomindEntityMappings = {
    user: {
        tableName: 'User',
        idField: 'id',
        fields: {
 ...
 */
export const taxomindToolConfigurations = {
    content: [
        {
            id: 'course_lookup',
            enabled: true,
 ...
 */
export const taxomindDataSources = [
    {
 ...
 */
export function createTaxomindIntegrationProfile(options) {
...
//# sourceMappingURL=taxomind-profile.js.map