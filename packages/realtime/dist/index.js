...
__export(index_exports, {
  ...
  NotificationPrioritySchema: () => NotificationPrioritySchema,
  NotificationSchema: () => NotificationSchema,
  PACKAGE_NAME: () => PACKAGE_NAME,
  PACKAGE_VERSION: () => PACKAGE_VERSION,
  PresenceChangeReasonSchema: () => PresenceChangeReasonSchema,
  PresenceManager: () => PresenceManager,
  PresenceStatusSchema: () => PresenceStatusSchema,
  REALTIME_CAPABILITIES: () => REALTIME_CAPABILITIES,
  RealtimeEventSchema: () => RealtimeEventSchema,
  RealtimeEventTypeSchema: () => RealtimeEventTypeSchema,
  UserPresenceSchema: () => UserPresenceSchema,
  WebSocketMessageSchema: () => WebSocketMessageSchema,
  createEventDispatcher: () => createEventDispatcher,
  createInMemoryNotificationStore: () => createInMemoryNotificationStore,
  createInMemoryPresenceStore: () => createInMemoryPresenceStore,
  createPresenceManager: () => createPresenceManager,
  createRealtimeSystem: () => createRealtimeSystem,
...
var PresenceStatusSchema = import_zod.z.enum(["online", "away", "busy", "offline"]);
var UserPresenceSchema = import_zod.z.object({
  userId: import_zod.z.string(),
  connectionId: import_zod.z.string(),
  status: PresenceStatusSchema,
  lastActivityAt: import_zod.z.date(),
  connectedAt: import_zod.z.date(),
  disconnectedAt: import_zod.z.date().optional(),
  deviceType: import_zod.z.enum(["desktop", "mobile", "tablet"]).optional(),
  ...
  pageUrl: import_zod.z.string().optional(),
  planId: import_zod.z.string().optional(),
  stepId: import_zod.z.string().optional(),
  goalId: import_zod.z.string().optional(),
  subscriptions: import_zod.z.array(import_zod.z.string()).default([]),
  metadata: import_zod.z.record(import_zod.z.unknown()).optional()
});
var PresenceChangeReasonSchema = import_zod.z.enum([
  "connect",
  "disconnect",
  "timeout",
  "activity",
...
var RealtimeEventTypeSchema = import_zod.z.enum([
  // Presence events
  "presence:connect",
  "presence:disconnect",
  "presence:update",
...
var RealtimeEventSchema = import_zod.z.object({
  ...
  priority: import_zod.z.enum(["low", "normal", "high", "urgent"]).default("normal"),
  ttl: import_zod.z.number().optional(),
  // Time-to-live in seconds
  requiresAck: import_zod.z.boolean().default(false)
});
var ChannelTypeSchema = import_zod.z.enum([
  "user",
...
var MessageTypeSchema = import_zod.z.enum([
  "event",
  // Real-time event
  "ack",
  // Acknowledgment
...
var NotificationPrioritySchema = import_zod.z.enum(["low", "normal", "high", "urgent"]);
var NotificationSchema = import_zod.z.object({
  ...
  iconType: import_zod.z.string().optional(),
  expiresAt: import_zod.z.date().optional(),
  createdAt: import_zod.z.date(),
  readAt: import_zod.z.date().optional(),
  metadata: import_zod.z.record(import_zod.z.unknown()).optional()
});
