...
| `docs/features/sam-ai-system/implementation/CONTEXT_AWARE_SAM_IMPLEMENTATION.md` | References missing components |
| `docs/features/sam-ai-system/implementation/SAM_MIGRATION_GUIDE.md` | Wrong API endpoint (`/api/sam/unified-assistant`) |
| `docs/features/sam-ai-system/implementation/SAM_ENGINES_FINAL_INTEGRATION.md` | Claims integration that doesn't exist |
...
docs/features/sam-ai-system/implementation/*.md          ← Audit and update or deprecate
```
