...
export const Card = ( props: ComponentPropsWithoutRef<"button"> & { color?:string; buttonText?:string }) => {
    ...
    return (
        <div className={twMerge("relative z-0 p-8 md:p-10 group", className)}>
            ...
            <div className={twMerge("absolute size-16 rounded-xl bg-fuchsia-500 group-hover:bg-fuchsia-400 transition duration-300 top-1.5 right-1.5 -z-10", 
                ...
                color === "cyan" && "bg-cyan-500 group-hover:bg-violet-400",
                color === "violet" && "bg-violet-500 group-hover:bg-violet-400",
                
                )}></div>
            <div className="absolute inset-0 -z-10 bg-zinc-800 rounded-2xl [mask-image:linear-gradient(225deg,transparent,transparent_40px,black_40px)]"></div>
