            ...
            >
              <div className="relative flex items-center bg-white dark:bg-slate-800 rounded-2xl shadow-2xl overflow-hidden">
                ...
                <Input
                  ...
                  className="pl-14 pr-4 py-6 text-lg border-0 focus-visible:ring-0 focus-visible:ring-offset-0 bg-transparent"
                />
                <Button
                  size="lg"
                  className="m-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg"
                  asChild
                >
                  <Link href={`/courses${searchQuery ? `?search=${searchQuery}` : ''}`}>
                    Search
                  </Link>
                </Button>
              </div>
              <p className="mt-3 text-sm text-slate-400 ml-1">
                Popular: <span className="text-blue-400">Web Development</span>, <span className="text-blue-400">Data Science</span>, <span className="text-blue-400">AI & Machine Learning</span>
              </p>
            </motion.div>
