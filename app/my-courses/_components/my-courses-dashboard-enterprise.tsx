    ...
    <div className="w-full min-h-screen pb-6 pt-2 sm:pt-3 md:pt-4">
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-indigo-300/10 rounded-full blur-3xl translate-y-1/2 translate-x-1/2 animate-pulse delay-700"></div>
          <div className="absolute top-1/2 left-1/2 w-72 h-72 bg-blue-300/10 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 animate-pulse delay-1000"></div>
        </div>

        <div className="relative z-10 px-3 sm:px-5 lg:px-6 py-6 sm:py-7 lg:py-8">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
            {/* User Info & Greeting */}
            <div className="flex-1">
              <div className="flex items-center gap-4 mb-4">
                <div className="relative">
                  <div className="w-16 h-16 lg:w-20 lg:h-20 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center text-2xl lg:text-3xl font-bold text-white border-2 border-white/30 shadow-lg">
                    {user?.name?.charAt(0)?.toUpperCase() || 'U'}
                  </div>
                  <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-emerald-500 rounded-full border-4 border-blue-500 dark:border-blue-600 shadow-md"></div>
                </div>
                <div>
                  <p className="text-sm lg:text-base text-white/80 font-medium mb-1">
                    Welcome back,
                  </p>
            ...
            <div className="flex flex-col sm:flex-row lg:flex-col gap-3">
              <Link href="/courses">
                <Button className="w-full sm:w-auto bg-white hover:bg-white/90 text-indigo-600 font-semibold shadow-lg hover:shadow-xl transition-all">
                  <Search className="w-4 h-4 mr-2" />
                  Explore Courses
                </Button>
              </Link>
              <Link href="/teacher/courses/create">
                <Button className="w-full sm:w-auto bg-white/20 hover:bg-white/30 text-white font-semibold backdrop-blur-sm border border-white/30 shadow-lg hover:shadow-xl transition-all">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3 lg:gap-4 mb-4 sm:mb-5 md:mb-6"
      >
        ...
        {stats.totalCreatedCourses > 0 && (
          ...
          >
            <Link href="/my-courses/analytics">
              <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-500 to-pink-500 dark:from-purple-600 dark:to-pink-600 p-6 lg:p-8 hover:shadow-2xl transition-all duration-300 cursor-pointer">
                ...
                <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="text-2xl font-bold text-white">Course Creator Analytics</h3>
        ...
        <div className="border-b border-slate-200/50 dark:border-slate-700/50 bg-white/40 dark:bg-slate-800/40 backdrop-blur-sm">
          <div className="p-3 sm:p-4 lg:p-5">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              ...
              >
                <TabsList className="grid w-full lg:w-auto grid-cols-2 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-1 rounded-xl border border-slate-200/50 dark:border-slate-700/50 shadow-sm">
                  <TabsTrigger
                    value="enrolled"
                    className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-indigo-500 data-[state=active]:text-white data-[state=active]:shadow-md text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-all duration-200 rounded-lg px-6 py-2.5 font-semibold text-sm"
                  >
              ...
              <div className="flex items-center gap-3">
                ...
                <Button
                  ...
                  className={cn(
                    'rounded-xl transition-all bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-slate-200/50 dark:border-slate-700/50 shadow-sm',
                    filterOpen &&
                ...
                <div className="hidden sm:flex items-center gap-1 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl p-1 border border-slate-200/50 dark:border-slate-700/50 shadow-sm">
                  <Button
                    variant="ghost"
                    size="icon"
            ...
            <>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 mb-6">
                <div className="flex flex-col sm:flex-row gap-3">
                  <Link href="/my-courses/analytics">
                    <Button className="w-full sm:w-auto bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white shadow-md hover:shadow-lg transition-all">
                      <BarChart3 className="w-4 h-4 mr-2" />
                      View Analytics
                    </Button>
                  </Link>
                  <Link href="/teacher/courses/create">
                    <Button className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white shadow-md hover:shadow-lg transition-all">
                      <Plus className="w-4 h-4 mr-2" />
                      Create New Course
                    </Button>
                  </Link>
