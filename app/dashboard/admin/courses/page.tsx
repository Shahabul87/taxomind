    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 dark:from-slate-900 dark:via-slate-800 dark:to-slate-700">
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        >
          ...
          <Button className="bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <Card className={cn(
                ...
                <div className="relative p-5">
                  ...
                  <div className="flex items-center gap-1 text-xs text-white/80">
                    {stat.change.includes('+') && <TrendingUp className="w-3 h-3" />}
                    {stat.change}
                  </div>
                </div>
              </Card>
        ...
        >
          <Card className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-slate-200/50 dark:border-slate-700/50 shadow-lg">
            ...
            <CardContent>
              {/* Courses Table */}
              <div className="overflow-x-auto rounded-lg border border-slate-200/50 dark:border-slate-700/50">
                <Table>
                  <TableHeader>
