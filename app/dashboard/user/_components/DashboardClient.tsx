...
// Hidden tabs (re-enable later): practice, cognitive, gamification, innovation, create, career, social, insights
const validTabs: DashboardView[] = ['todos', 'analytics', 'skills', 'goals', 'gaps'];
