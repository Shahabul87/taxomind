...
export default async function TeacherCoursesLayout({
  ...
  return (
    <>
      ...
      <div className="min-h-screen pt-16 bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 dark:from-slate-900 dark:via-slate-800 dark:to-slate-700 ml-[72px] transition-all duration-300">
        {children}
      </div>
    </>
  );
