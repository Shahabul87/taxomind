...
import { CheckCircle2, ChevronRight, Circle, Clock, Eye, FileText, Image, Layout, NotebookPen, ArrowLeft } from "lucide-react";
...
export default function EnterpriseEditPost(props: EnterpriseEditPostProps) {
  ...
  // Determine current step (first incomplete, else last)
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-6">
      ...
      <div className="mb-6 rounded-xl border bg-white/60 dark:bg-gray-900/60 backdrop-blur-md border-gray-200/70 dark:border-gray-800/70 shadow-sm overflow-hidden">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 p-4 md:p-6">
          <div className="min-w-0">
            <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400 mb-1">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <h1 className="text-2xl md:text-3xl font-bold tracking-tight bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent truncate">Edit Post</h1>
              <Badge className={cn(
                "rounded-full",
                published
          ...
          <div className="flex items-center gap-2">
            <Link href="/teacher/posts/all-posts" className="inline-flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300 hover:underline" aria-label="Back to all posts">
              <ArrowLeft className="w-4 h-4" /> Back
            </Link>
            <Link href={`/blog/${postId}`} target="_blank" rel="noopener noreferrer" className="text-sm text-gray-600 dark:text-gray-300 hover:underline">Preview</Link>
        ...
        <div className="px-4 md:px-6 pb-4">
          ...
          <div className="mt-2 text-xs text-gray-500 dark:text-gray-400" aria-live="polite">Progress: {pct}%</div>
        </div>
        {!published && (
          <div className="px-4 md:px-6 pb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[240px_1fr_280px] gap-6">
        {/* Stepper */}
        <aside className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white/60 dark:bg-gray-900/60 backdrop-blur-md p-4 h-fit" role="navigation" aria-label="Editor steps">
          ...
          <div className="space-y-4 relative">
            {steps.map((step, idx) => {
              const sectionId = idx === 0 ? 'section-basics' : idx === 1 ? 'section-description' : idx === 2 ? 'section-content' : 'section-image';
              ...
              return (
                <button
                  ...
                  className="flex items-center gap-3 w-full text-left focus:outline-none focus:ring-2 focus:ring-indigo-400 rounded-lg p-1 hover:bg-gray-50 dark:hover:bg-gray-800/50"
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-gray-400 dark:text-gray-500">{step.done ? "Complete" : isCurrent ? "Current" : "Pending"}</div>
                  </div>
                </button>
              );
            })}
        ...
        <main className="space-y-6">
          {/* Title & Category */}
          <section id="section-basics" className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white/90 dark:bg-gray-900/70 backdrop-blur-md shadow-md overflow-hidden">
          ...
          {/* Description */}
          <section id="section-description" className="rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/70 backdrop-blur-md shadow-md overflow-hidden">
            <div className="p-5 md:p-6 border-b border-gray-200/70 dark:border-gray-800/70">
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-indigo-500" />
          ...
          {/* Content Sections */}
          <section id="section-content" className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white/90 dark:bg-gray-900/70 backdrop-blur-md shadow-md overflow-hidden">
            <div className="p-5 md:p-6 border-b border-gray-200/70 dark:border-gray-800/70">
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-indigo-500" />
          ...
          {/* Image */}
          <section id="section-image" className="rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/70 backdrop-blur-md shadow-md overflow-hidden">
            <div className="p-5 md:p-6 border-b border-gray-200/70 dark:border-gray-800/70">
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-indigo-500" />
      ...
      <div className="sticky bottom-0 z-40 mt-6">
        <div className="backdrop-blur bg-white/70 dark:bg-gray-900/70 border-t border-gray-200 dark:border-gray-800">
          <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-3 flex items-center justify-between">
            <div className="text-xs text-gray-500 dark:text-gray-400" aria-live="polite">Completion {completionText}</div>
            <div className="flex items-center gap-2">
