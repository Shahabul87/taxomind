...
export default function HomeHeroSectionRedesigned() {
  ...
  return (
    ...
    >
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="sm:hidden">
              {user ? (
                ...
                <Link
                  href="/auth/login"
                  className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white transition-all font-semibold text-xs shadow-md hover:shadow-lg"
      ...
      <div className="absolute top-3 right-4 z-50 hidden sm:block sm:top-4 sm:right-6 md:right-8 lg:right-20">
        {user ? (
          <UserMenu user={user} />
        ) : (
          <Link
