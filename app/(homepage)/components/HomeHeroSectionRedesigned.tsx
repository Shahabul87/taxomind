...
export default function HomeHeroSectionRedesigned() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 dark:from-slate-900 dark:via-slate-800 dark:to-slate-700 min-h-screen flex items-center py-12 sm:py-16 md:py-20 lg:py-24"
    >
      {/* Top Navigation - Logo left, AI Links center, User right */}
      <div className="absolute top-3 left-0 right-0 z-50 sm:top-4">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            {/* Center - AI News & Research Links (Desktop) */}
            ...
            {/* Center - AI News & Research Links (Mobile) */}
            ...
            <div className="flex items-center">
              {user ? (
                ...
                <Link
                  href="/auth/login"
                  className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white transition-all font-semibold text-xs sm:text-sm shadow-md hover:shadow-lg"
      ...
      <div className="absolute inset-0 opacity-20 sm:opacity-30" aria-hidden="true">
        <div className="absolute top-20 left-4 sm:left-10 w-48 h-48 sm:w-72 sm:h-72 bg-blue-200 dark:bg-blue-900/20 rounded-full mix-blend-multiply dark:mix-blend-overlay filter blur-3xl motion-safe:animate-pulse motion-reduce:animate-none" />
        <div className="absolute top-40 right-4 sm:right-20 w-64 h-64 sm:w-96 sm:h-96 bg-indigo-200 dark:bg-indigo-900/20 rounded-full mix-blend-multiply dark:mix-blend-overlay filter blur-3xl motion-safe:animate-pulse motion-reduce:animate-none" style={{ animationDelay: '1s' }} />
        <div className="absolute -bottom-20 left-1/4 sm:left-1/3 w-56 h-56 sm:w-80 sm:h-80 bg-purple-200 dark:bg-purple-900/20 rounded-full mix-blend-multiply dark:mix-blend-overlay filter blur-3xl motion-safe:animate-pulse motion-reduce:animate-none" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="container relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20">
        <div className="grid grid-cols-1 items-center gap-6 sm:gap-8 lg:grid-cols-12 lg:gap-12">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 md:space-y-8">
            ...
            >
              ...
              >
                <div className="relative">
                  ...
                  <div className="relative w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 shadow-lg flex items-center justify-center ring-2 ring-purple-300/50 dark:ring-purple-500/30 group-hover:shadow-xl transition-all">
                    <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-white/20 to-transparent" />
                    <Lightbulb className="relative w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white drop-shadow-md" />
                  </div>
                </div>
                <span className="text-[10px] sm:text-xs md:text-sm font-bold tracking-wide text-purple-700 dark:text-purple-300 uppercase">Create</span>
              </motion.div>
              ...
              >
                ...
                <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 dark:text-blue-400" strokeWidth={2.5} aria-hidden="true" />
              </motion.div>
              ...
              >
                <div className="relative">
                  ...
                  <div className="relative w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-blue-500 to-indigo-500 shadow-lg flex items-center justify-center ring-2 ring-blue-300/50 dark:ring-blue-500/30 group-hover:shadow-xl transition-all">
                    <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-white/20 to-transparent" />
                    <Brain className="relative w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white drop-shadow-md" />
                  </div>
                </div>
                <span className="text-[10px] sm:text-xs md:text-sm font-bold tracking-wide text-blue-700 dark:text-blue-300 uppercase">Learn</span>
              </motion.div>
              ...
              >
                ...
                <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600 dark:text-emerald-400" strokeWidth={2.5} aria-hidden="true" />
              </motion.div>
              ...
              >
                <div className="relative">
                  ...
                  <div className="relative w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-emerald-500 to-teal-500 shadow-lg flex items-center justify-center ring-2 ring-emerald-300/50 dark:ring-emerald-500/30 group-hover:shadow-xl transition-all">
                    <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-white/20 to-transparent" />
                    <Share2 className="relative w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white drop-shadow-md" />
                  </div>
                </div>
                <span className="text-[10px] sm:text-xs md:text-sm font-bold tracking-wide text-emerald-700 dark:text-emerald-300 uppercase">Share</span>
              </motion.div>
            </motion.div>
            ...
            {/* Description */}
            <motion.p
              className="text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed sm:leading-relaxed text-slate-600 dark:text-slate-300 max-w-2xl mx-auto lg:mx-0 text-center lg:text-left px-2 sm:px-0"
              variants={fadeInUp}
              initial="hidden"
              animate={isInView ? 'visible' : 'hidden'}
            ...
            >
              <motion.div
                variants={fadeInUp}
                className="inline-flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50 shadow-sm hover:shadow-md transition-all"
              >
                <Activity className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-600 dark:text-blue-400" />
                <span className="text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300">6 Cognitive Levels</span>
              </motion.div>
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300">AI Evaluation</span>
              </motion.div>
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300">Real-Time Tracking</span>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              <Link href="/courses" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full border-2 border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 hover:bg-slate-50 hover:text-slate-900 dark:hover:bg-slate-800/50 dark:hover:text-white backdrop-blur-sm px-6 py-5 sm:px-8 sm:py-6 text-sm sm:text-base font-semibold rounded-xl transition-all"
                >
                  Explore Courses
                </Button>
              </Link>
            ...
            {/* Trust Indicators */}
            <motion.div
              className="flex flex-wrap items-center justify-center lg:justify-start gap-4 sm:gap-6 pt-2 sm:pt-4 opacity-70 px-2 sm:px-0"
              variants={fadeInUp}
              initial="hidden"
              animate={isInView ? 'visible' : 'hidden'}
            ...
            >
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Research-Backed</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-full max-w-[280px] sm:max-w-sm">
                  ...
                  {/* Main card */}
                  <div className="relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50 shadow-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8">

                    {/* Bloom's Taxonomy Levels */}
                    <div className="space-y-2 sm:space-y-3 md:space-y-4">
                      <div className="text-center mb-4 sm:mb-5 md:mb-6">
                        <h3 className="text-sm sm:text-base md:text-lg font-bold text-slate-900 dark:text-white mb-0.5 sm:mb-1">Bloom&apos;s Taxonomy</h3>
                        <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Track Your Cognitive Growth</p>
                      </div>
                      ...
                      {[
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <motion.span
                              className="text-[10px] sm:text-xs font-semibold text-slate-700 dark:text-slate-300"
                              initial={{ opacity: 0 }}
                            ...
                            <motion.span
                              className="text-[10px] sm:text-xs font-bold text-slate-600 dark:text-slate-400"
                          ...
                          <div className="h-1.5 sm:h-2 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden relative">
                            <motion.div
              ...
              >
                <div className="flex items-center gap-1 sm:gap-2">
                  ...
                  <span className="text-[10px] sm:text-xs md:text-sm font-semibold text-slate-900 dark:text-white">AI Analyzing</span>
                </div>
              </motion.div>
              ...
              >
                <Link
                  ...
                  className="group inline-flex items-center gap-1 sm:gap-2 px-2 py-1 sm:px-3 sm:py-1.5 md:px-4 md:py-2 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm rounded-lg sm:rounded-xl shadow-lg border border-blue-200 dark:border-blue-500/30 hover:border-blue-400 dark:hover:border-blue-400 hover:shadow-xl transition-all duration-300 cursor-pointer"
                  aria-label="Learn how Bloom's Taxonomy works"
                >
                  <Sparkles className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-blue-600 dark:text-blue-400 motion-safe:animate-pulse motion-reduce:animate-none group-hover:scale-110 transition-transform" />
                  <span className="text-[10px] sm:text-xs md:text-sm font-semibold text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                    How It Works?
                  </span>
                </Link>
              </motion.div>
