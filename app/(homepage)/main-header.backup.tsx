                  ...
                  {showDesktopIntelligentLMSDropdown && (
                    ...
                    >
                      <div className="relative">
                        ...
                        {/* Panel */}
                        <div className="relative w-[95vw] sm:w-[85vw] md:w-[600px] lg:w-[720px] xl:w-[800px] max-w-[calc(100vw-2rem)] backdrop-blur-xl backdrop-saturate-150 rounded-xl shadow-[0_16px_40px_-10px_rgba(2,6,23,0.5)] dark:shadow-[0_20px_50px_-12px_rgba(0,0,0,0.8)] border bg-white/95 dark:bg-slate-900/95 border-slate-200/80 dark:border-slate-600/50 overflow-hidden">
                          {/* Accent line */}
                          ...
                          <div className="p-4 space-y-3">
                            ...
                            >
                              <div className="flex items-start gap-3">
                                <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-purple-500 to-blue-500 dark:from-purple-400 dark:to-blue-400 text-white shadow-md dark:shadow-lg flex items-center justify-center flex-shrink-0">
                                ...
                                <div className="min-w-0 flex-1">
                                  ...
                                  <p className="mt-1 text-sm leading-snug text-slate-700 dark:text-gray-200">Adaptive pathways, rigorous evaluation, and AI‑driven course intelligence.</p>
                                </div>
                              </div>
                              <div className="mt-3 flex items-center gap-2 text-sm font-medium text-purple-700 dark:text-purple-400">
                  ...
                  {showDesktopAIToolsDropdown && (
                    ...
                    >
                      <div className="relative">
                        ...
                        {/* Panel */}
                        <div className="relative w-[95vw] sm:w-[85vw] md:w-[550px] lg:w-[640px] xl:w-[720px] max-w-[calc(100vw-2rem)] backdrop-blur-xl backdrop-saturate-150 rounded-xl shadow-[0_16px_40px_-10px_rgba(2,6,23,0.5)] dark:shadow-[0_20px_50px_-12px_rgba(0,0,0,0.8)] border bg-white/95 dark:bg-slate-900/95 border-slate-200/80 dark:border-slate-600/50 overflow-hidden">
                          {/* Accent line */}
                          ...
                          <div className="p-4 space-y-3">
                            ...
                            >
                              <div className="flex items-start gap-3">
                                <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-indigo-500 to-cyan-500 dark:from-indigo-400 dark:to-cyan-400 text-white shadow-md dark:shadow-lg flex items-center justify-center flex-shrink-0">
                                ...
                                <div className="min-w-0 flex-1">
                                  ...
                                  <p className="mt-1 text-sm leading-snug text-slate-700 dark:text-gray-200">Curated assistants, market trends, news, and research.</p>
                                </div>
                              </div>
                              <div className="mt-3 flex items-center gap-2 text-sm font-medium text-indigo-700 dark:text-indigo-400">
