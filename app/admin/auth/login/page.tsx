                ...
                <div className="relative z-10 flex flex-col justify-center space-y-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
                      Secure access for administrators. All sign-ins are monitored and protected with multi-factor authentication.
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3 group">
                      ...
                      <span className="text-sm font-medium text-slate-700 dark:text-slate-300">Role-based access control</span>
                    </div>
                    ...
                    <div className="flex items-center gap-3 group">
                      ...
                      <span className="text-sm font-medium text-slate-700 dark:text-slate-300">Session integrity verification</span>
                    </div>
                    ...
                    <div className="flex items-center gap-3 group">
                      ...
                      <span className="text-sm font-medium text-slate-700 dark:text-slate-300">Comprehensive audit logging</span>
                    </div>
                  </div>
                ...
                <div className="w-full max-w-md">
                  <Suspense fallback={
                    <div className="p-8 text-center">
                      ...
                      <p className="mt-4 text-sm text-slate-600 dark:text-slate-400">Loading admin authentication...</p>
                    </div>
                  }>
                    <AdminLoginForm />
                  </Suspense>
