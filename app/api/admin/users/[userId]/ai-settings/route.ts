...
export const GET = withRole(
  ...
  async (request: NextRequest, { params }: RouteParams) => {
    ...
    try {
      ...
      // Fetch user with AI preferences
      ...
      // Fetch platform settings for tier defaults
...
export const PUT = withRole(
  ...
  async (request: NextRequest, { params }: RouteParams) => {
    ...
    try {
      ...
      const adminId = adminSession?.user?.id ?? "unknown";

      // Get EnterpriseDB for audited operations
      ...
      // Prepare AI preferences update data
      ...
      // Fetch tier limits for response
