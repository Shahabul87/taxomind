/**
 * DEPRECATED: /api/sam/course-assistant-enhanced
 *
 ...
 *   { response, suggestions, actionsTaken, data, timestamp }
 */
...
export async function POST(request: NextRequest) {
  logger.warn('[SAM-COURSE-ASSISTANT-ENHANCED] Deprecated route called — forwarding to /api/sam/unified');
  ...
  try {
    ...
    // Map unified response → legacy course-assistant-enhanced format
    ...
    logger.error('[SAM-COURSE-ASSISTANT-ENHANCED] Proxy error:', error);
