  ...
  return (
    ...
    >
      <div className="relative w-full">
        ...
        <div className="absolute bottom-4 right-10 flex gap-2 z-50">
          <button
...
export const Card = ({
  ...
  // Define handleClose before using it in useEffect and useOutsideClick
...
export const BlurImage = ({
  ...
  return (
    <Image
      ...
      src={src}
      // Only use width/height if not using fill
